export class ValidationService {
    static getValidatorErrorMessage(validatorName: string, propertyName: string, validatorValue?: any, mask?: string) {
        let config: any = {
            ...
            mask: `Solo se aceptan los siguientes formatos: ${mask}`
        }
